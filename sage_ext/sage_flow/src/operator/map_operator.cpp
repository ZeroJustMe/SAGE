...
MapOperator::MapOperator(std::string name)
    : Operator(OperatorType::kMap, std::move(name)), map_function_(nullptr) {}

MapOperator::MapOperator(std::string name, std::unique_ptr<MapFunction> map_function)
    : Operator(OperatorType::kMap, std::move(name)), map_function_(std::move(map_function)) {}
