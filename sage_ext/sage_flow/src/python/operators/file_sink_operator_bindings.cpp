...
#include "operator/file_sink_operator.h"
...
void BindFileSinkOperator(py::module& m) {
    ...
    py::class_<sage_flow::FileSinkOperator, sage_flow::Operator>(m, "FileSinkOperator")
    ...
    m.def("CreateFileSink", &sage_flow::CreateFileSink,
          ...
          py::arg("file_path"), 
          py::arg("format") = sage_flow::FileFormat::TEXT, 
