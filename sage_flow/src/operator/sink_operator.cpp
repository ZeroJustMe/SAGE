...
SinkOperator::SinkOperator(std::string name)
    : Operator(OperatorType::kSink, std::move(name)), sink_function_(nullptr) {}

SinkOperator::SinkOperator(std::string name, std::unique_ptr<SinkFunction> sink_function)
    : Operator(OperatorType::kSink, std::move(name)), sink_function_(std::move(sink_function)) {}
...
void SinkOperator::setSinkFunction(std::unique_ptr<SinkFunction> sink_function) {
